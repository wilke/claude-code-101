...
Pick one (or bring your own research problem) and follow the setup below.

## Common `README.md` for all capstone projects

1. Create your own git repo for your project.
2. Copy the `README.md` file of your [capstone project](/capstones/).
3. Create a suitable directory structure, e.g. `plans/`, `src/`, `paper/`, ...
