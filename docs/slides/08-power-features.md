<!--slide n=36 layout=section kicker="Part 5 · Power features"-->
# Beyond the basics
...
<!--slide n=37 layout=content kicker="Power features"-->
...
<!--slide n=38 layout=content kicker="Power features"-->
# Subagents and hooks
|  | Skill | Subagent | Hook |
|---|---|---|---|
...
<!--slide n=39 layout=content kicker="Power features"-->
